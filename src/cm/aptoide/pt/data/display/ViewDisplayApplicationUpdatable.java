 ...
 *
 */
public class ViewDisplayApplicationUpdatable implements Parcelable{
	 ...
	 */
	public ViewDisplayApplicationUpdatable(int appHashid, String appName, float stars, int downloads, String upToDateVersionName) {
	 ...
	 */
	public ViewDisplayApplicationUpdatable(int appHashid, String appName, String installedVersionName, boolean isUpdatable, String upToDateVersionName, boolean isDowngradable, String downgradeVersionName) {
		this.appHashid = appHashid;
		this.iconCachePath = Constants.PATH_CACHE_ICONS+appHashid;
	...
	public boolean equals(Object object) {
		if(object instanceof ViewDisplayApplicationUpdatable){
			ViewDisplayApplicationUpdatable app = (ViewDisplayApplicationUpdatable) object;
