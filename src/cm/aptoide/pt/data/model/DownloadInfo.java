...
import cm.aptoide.pt.data.downloads.BareDownloadInfo;
...
public class DownloadInfo implements InterfaceDownloadInfo {
	...
	private void setRemotePathTail(String remotePathTail){
		this.values.put(Constants.KEY_ICON_REMOTE_PATH_TAIL, remotePathTail);		
	}
	
	public String getRemotePathTail(){
		return this.values.getAsString(Constants.KEY_ICON_REMOTE_PATH_TAIL);
	}
	
	private void setAppFullHashid(int appFullHashid){
		this.values.put(Constants.KEY_ICON_APP_FULL_HASHID, appFullHashid);
	}
