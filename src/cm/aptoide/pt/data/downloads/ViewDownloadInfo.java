...
public class ViewDownloadInfo {
	 ...
	 * @param downloadType
	 */
	public ViewDownloadInfo(String remotePath, String localPath, String appName, int appHashid, EnumDownloadType downloadType) {
	 ...
	 * @param downloadType
	 */
	public void reuse(String remotePath, String localPath, String appName, int applicationHashid, EnumDownloadType downloadType) {
		this.remotePath = remotePath;
		this.localPath = localPath;
		this.appName = appName;
