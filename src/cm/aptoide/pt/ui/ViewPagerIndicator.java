...
public class ViewPagerIndicator extends RelativeLayout implements OnPageChangeListener {
	...
	void updateColor(int offset){
		...
		//int r = (int)(mUnfocusedTextColor[0] * fraction + mFocusedTextColor[0] * (fraction + 1));
		//int g = (int)(mUnfocusedTextColor[1] * fraction + mFocusedTextColor[1] * (fraction + 1));
		//int b = (int)(mUnfocusedTextColor[2] * fraction + mFocusedTextColor[2] * (fraction + 1));

		//same as the greenbar color
		mCurrent.setTextColor(Color.argb(255, 131, 194, 0));
	}
