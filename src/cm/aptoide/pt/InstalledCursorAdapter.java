...
public class InstalledCursorAdapter extends CursorAdapter {

	DBHandler database;
	boolean download;
	public InstalledCursorAdapter(Context context, Cursor c, int flags) {
		super(context, c, flags);
		this.context=context;
		imageLoader = new ImageLoader(context);
		updates = new GetUpdatesAvailable(context);
//		database= new DBHandler(context);
		
	}
	private ImageLoader imageLoader;
	private Context context;
	GetUpdatesAvailable updates;
	@Override
	public void bindView(View view, Context arg1, Cursor cursor) {
        ...
        updates.getCount(cursor.getString(7), holder.vername, cursor.getString(3));
